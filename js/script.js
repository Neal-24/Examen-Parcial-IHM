...
$(".idiomasEn").click(function () {
    ...
    $(".idiomasEs").removeClass("bg-info")
    $(".idiomasEs").removeClass("text-white")

    $(".idiomasEs").addClass("bg-white")
    $(".idiomasEs").addClass("text-dark")
})

$(".idiomasEs").click(function () {
    ...
    $(".idiomasEn").removeClass("bg-info")
    $(".idiomasEn").removeClass("text-white")

    $(".idiomasEn").addClass("bg-white")
    $(".idiomasEn").addClass("text-dark")
})
...
/* Visualizador Multimedia Habitacion*/
...
$('#calendar').fullCalendar({
    ...
    events:[
        ...
        {
            start: '2020-06-22',  /* habrá una próxima reserva*/
            end: '2020-06-24',
            rendering:'background',
            color: '#FFCC29'
